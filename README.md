...
![foodgram_workflow](https://github.com/Abassssss/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)
...
```
git clone https://github.com/Abassssss/foodgram-project-react.git
...
```
Заполнить базу ингридиентами, тегами и тестовыми данными:
```
1) копируем папку data в контейнер backend: docker cp ./data [container_id]:/app/data

2) выполняем команду seed docker-compose exec backend python manage.py seed
```